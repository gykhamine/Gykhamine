...
class SettingsDialog(Adw.PreferencesDialog):
    def __init__(self, parent, config: dict, on_save):
        ...
        page.add(grp_pg)
        pg_device_row = DirectoryPickerRow(title="Périphérique de la partition (optionnel)", subtitle="Laissez vide : /var est déjà un dossier local sur le système installé. Ne renseignez /dev/sdX que pour monter un stockage externe dédié.", initial_value=config.get("pg_device", ""), filename="")
