...
class DjangoMasterDocDialog(Gtk.Dialog):
    def __init__(self, parent):
        ...
        # Layout Principal : Sidebar (Gauche) + Contenu (Droite), redimensionnable
        # par l'utilisateur (Gtk.Paned) au lieu d'une largeur de sidebar figée
        # à 320px qui pouvait rendre la zone de texte disproportionnellement
        # petite selon la taille de la fenêtre.
        main_box = Gtk.Paned(orientation=Gtk.Orientation.HORIZONTAL)
        main_box.set_hexpand(True)
        main_box.set_vexpand(True)
        main_box.set_position(260)
        ...
        sidebar.set_size_request(200, -1)  # largeur minimale, plus une limite figée
        ...
        apply_dark_source_scheme(self.content_view.get_buffer())
