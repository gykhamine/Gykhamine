...
window, dialog, popover, scrolledwindow, viewport, button, entry, textview, listbox, treeview, columnview, listview, headerbar, box, stack, notebook, .background, .csd, preferencesdialog, preferencespage, preferencesgroup, actionrow, entryrow, switchrow, comborow, toastoverlay, toolbarview, windowhandle, navigation-view, navigation-page, paned, dropdown, popover.menu, popover.background, popover contents, menu, modelbutton {
    background-color: #000000;
    color: #4aa3df;
}

/* ── Paned (séparateur redimensionnable, ex: Django Master Doc) ── */
paned > separator {
...
/* ── DropDown (listes déroulantes : sélecteur de volume, tables DB, etc.) ── */
...
dropdown popover, dropdown popover contents, dropdown listview, dropdown listview row {
    background-color: #000000;
    color: #4aa3df;
}
...
/* ── TreeView (explorateur de fichiers) et ColumnView (DB Manager) ── */
treeview, treeview.view, columnview, columnview.view, listview, listview.view {
    background-color: #000000;
    color: #4aa3df;
}
treeview.view row,
treeview.view row cell,
columnview row,
columnview cell,
listview row {
    background-color: #000000;
...
/* ── CheckButton / ToggleButton (ex: case "Auto" des capsules/services) ── */
