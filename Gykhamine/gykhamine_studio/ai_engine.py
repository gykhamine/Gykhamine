...
class BlockAIEngine:
    ...
    def _build_prompt(self, block_type, current_code, user_intent, context_deps="", mode="modify", custom_role=None):
        ...
        if mode == "contextual_modify":
            ...
            format_instruction = "Analyse les logs fournis en texte libre : décris l'erreur, la cause technique, la solution proposée et la sévérité. Pas de format imposé, pas de markdown."
        elif mode == "business_process":
            format_instruction = "Réponds en texte libre, structuré et clair selon les instructions de ton rôle. Pas de format imposé, pas de markdown."
        else:
