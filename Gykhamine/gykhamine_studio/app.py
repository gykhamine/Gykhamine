...
class GykhamineStudioApp(Adw.Application):
    ...
    def _on_activate(self, app):
        ...
        def _register_actions():
            ...
            # Complète automatiquement la liste avec toutes les autres actions
            # (boutons) déjà présentes dans le code de l'app, sans dupliquer
            # celles enregistrées manuellement ci-dessus.
            rm.auto_discover_actions(self)
    ...
    def _setup_keyboard_shortcuts(self):
        ...
        # Ctrl+R = Ouvrir les Runtimes
        key_ctrl_r = Gtk.ShortcutTrigger.parse_string("<Control>r")
        action_runtime = Gtk.CallbackAction.new(lambda *_: self._open_runtime_dialog())
        self.win.add_shortcut(Gtk.Shortcut.new(key_ctrl_r, action_runtime))
